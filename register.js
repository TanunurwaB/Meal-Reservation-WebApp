...
app.post('/', async (req, res) => {
    const { username, email, phone, password, category } = req.body; // Include category

    // Validate input
    if (!username || !email || !phone || !password || !category) { // Check for category
    ...
    try {
        ...
        // Insert the new user into the database, including the category
